...
; RUN: llc < %s -mtriple=x86_64-linux-gnu -mattr=avxneconvert,f16c | FileCheck %s --check-prefixes=FTZDAZ
; RUN: llc < %s -mtriple=x86_64-linux-gnu -denormal-fp-math-bf16=ieee -mattr=avxneconvert,f16c | FileCheck %s --check-prefixes=NOFTZDAZ
; RUN: llc < %s -mtriple=x86_64-linux-gnu -denormal-fp-math-bf16=preserve-sign -mattr=avxneconvert,f16c | FileCheck %s --check-prefixes=FTZDAZ
...
define void @add_no_ftz_daz_attr(ptr %pa, ptr %pb, ptr %pc) #0 {
...
attributes #0 = { nounwind "denormal-fp-math-bf16"="ieee,ieee" }
